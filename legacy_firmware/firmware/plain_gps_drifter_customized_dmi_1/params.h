...
// GNSS params
    ...
    constexpr unsigned long timeout_gnss_fix_seconds = 2UL * 60UL;
    ...
    constexpr long interval_between_gnss_measurements_seconds = 10L * 60L;  // a reasonable value
    ...
    constexpr size_t min_nbr_of_fix_per_message = 11;  // a reasonable value
...
constexpr bool use_wave_measurements {false};
