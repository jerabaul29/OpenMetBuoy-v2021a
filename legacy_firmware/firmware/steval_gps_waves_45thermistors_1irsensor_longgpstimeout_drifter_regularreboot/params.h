...
// GNSS params
    ...
    constexpr unsigned long timeout_gnss_fix_seconds = 6UL * 60UL;
    ...
    constexpr size_t size_gps_fix_buffer = 150;  // a reasonable value
...
constexpr int number_of_thermistors {45};
...
constexpr size_t max_nbr_thermistor_packets {1};

// min number of thermistors readings sent at once by defaul
constexpr size_t min_default_nbr_thermistor_packets {1};

// how many thermistor packets we keep in memory
constexpr size_t size_thermistors_packets_buffer {16};
