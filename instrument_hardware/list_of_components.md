...
- if using the PCB, male and female headers to put on: you will need standard 0.1" / 2.54mm, 1 row, male and female; count about up to 100 male and 100 female headers per buoy when populating all headers on the PCB; for example something like:
